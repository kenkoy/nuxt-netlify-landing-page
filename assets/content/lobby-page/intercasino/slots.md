...
seo:
  alternate_links:
    - hreflang: x-default
      href: https://www.intercasino
    - hreflang: ja-jp
      href: https://www.intercasino/en
  title: オンライン ビデオスロット | InterCasino(インターカジノ)
  meta:
    description: オンラインでスロット！？インターカジノなら1300種類を超えるビデオスロットをオンラインで楽しむことができちゃいます。パソコンやスマホなどのネット環境さえあればOK。インターカジノのオンラインビデオスロットで大勝利を収めましょう。
    robots: noindex
banner:
  - image: /marketing/img/269_bg.jpg
    url: www.verajohn.com/slots
game:
  game_list:
    - is_hot: true
...
<p class="n-paragraph"><a href="https://www.intercasino.com/" class="n-link">ホームに戻ってインターカジノのすべてのゲームを見る</a></p>