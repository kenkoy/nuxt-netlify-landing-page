  ...
  <section id="second" class="main special">
    <ul class="items-list">
      <li class="style1">
        ...
        <img src="/marketing/img/vjhp/reward-component_1.png" alt=""/>
      </li>
      <li class="style1">
        <h3>ご褒美プログラム</h3>
        <p>楽しく遊んでコインを集めて、ベラジョン・ショッ プでお買い物! フリースピンやスピンクレジット、キャッシュアイ テムとも交換できちゃいます!</p>
        <img src="/marketing/img/vjhp/reward-component_2.png" alt=""/>
      </li>
      <li class="style1">
        <h3>毎日開催トーナメント</h3>
        <p>
         ...
         <img src="/marketing/img/vjhp/reward-component_3.png" alt=""/>
      </li>
    </ul>
  </section>
</template>