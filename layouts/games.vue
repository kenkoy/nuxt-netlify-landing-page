        ...
        <div class="container main-content">
          <div>
            ...
            <aside v-if="filteredGames.length >= limit" id="pagination-wrapper">
              ...
              <a v-if="filteredGames.length !== 0 && (filteredGames.length + limit) - filteredGames.length < gameData.games.length" class="load-more" @click="showMore">
                Load more
              </a>
              <h3 v-if="(filteredGames.length + limit) - filteredGames.length === gameData.games.length">
                All games shown
              </h3>
            </aside>
          </div>
...
export default {
  ...
  methods: {
    ...
    getGameCategoryEmit (gameDataEmit) {
