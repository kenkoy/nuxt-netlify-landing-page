        ...
        <header class="desktop">
          <div class="container">
            <div class="row">
              ...
              <div class="join btn-register" aria-label="join">
                ...
                <div id="firstvie__inquiry" class="firstvie__inquiry">
                  <div>
                    <div class="firstvie__inquiry__inner">
                      ...
                      <a class="btn-register" :href="data_items.attributes.promo_banner.promo_join_url">{{ data_items.attributes.promo_banner.promo_join_text }}</a>
                      <button onclick="back()">
                        ▶まだまだ触る！
                      </button>
                    </div>
