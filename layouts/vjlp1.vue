    ...
    head() {
      return {
        link: [
          ...
          { rel: 'stylesheet', href: '/marketing/styles/vjlp1/core.css' },
          { defer: true, rel: 'stylesheet', href: '/marketing/styles/vjlp1/brand.css' }, //
          { rel: 'stylesheet', href: '/marketing/styles/vjlp1/responsive.css' },
