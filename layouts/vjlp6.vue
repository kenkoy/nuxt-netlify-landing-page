          ...
          <div class="strip">
            ...
            <div>
              ...
              <div class="small-terms banner-terms" data-v-835fbe4a="">
                ...
                ><span v-for="(terms_data, terms_index) in data_items.attributes.promo_banner.promo_terms_link_text" :key="terms_index">{{ terms_data }}</span></a>{{ data_items.attributes.promo_banner.promo_terms_text }}
              </div>
            </div>
          </div>
        </div>
