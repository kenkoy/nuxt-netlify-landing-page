...
<script>
export default {
  layout: 'brands', // Change to actual layout
  async asyncData ({ params, error }) {
    try {
      const markDownData = await import('~/assets/content/landing-page/marketing/games/' + params.slug + '.md') // Change to actual slug
      return { markDownData }
    } catch (e) {
      error(e)
    }
  ...
  methods: {
    emitData (data) {
      this.$root.$emit('brands-data', { // Change to actual page name
