...
export const VJLP7_PREVIEW = createClass({
  render () {
    ...
    .vjlp7_wrapper .version1 button a, .vjlp7_wrapper .version1 button a:hover {
    color: #704B1F;
    }
    ...
    .vjlp7_wrapper ul li, .vjlp7_wrapper p {
    color: #fff;
    font-size: 16px;
    ...
    .vjlp7_wrapper #nav-desktop #vj, .vjlp7_wrapper #nav-desktop #ic {
    background: #e4e4e4;
    color: #a9a9a9;
    border-radius: 3px;
    padding: 5px 10px;
