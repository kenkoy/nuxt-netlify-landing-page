...
const VJLP3V2_DIR = '/assets/content/landing-page/marketing/vjlp3/'

describe('Testing vjlp3 version 2 index.vue', () => {
  ...
  beforeAll(async () => {
    ...
    const md = _
      .chain(await retrieveFiles(VJLP3V2_DIR, '.md'))
      .map(files => VJLP3V2_DIR + files)
      .sample()
      .value()
